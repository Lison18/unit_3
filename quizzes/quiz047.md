...
from secure_password_quiz47 import encrypt_password
    ...
    def update(self):
        ...
        if base != "":
            ...
            for item in ["inhabitant","income_tax","pension","health"]:
                ...
                print(new_value)
                self.root.ids[item + "_label"] = new_value


            hash += f"total{total}"
            self.root.ids.salary_label.text = f"Total {total}"
            y = encrypt_password(hash)
...
https://user-images.githubusercontent.com/116609563/226113659-2391e829-0f70-450f-a005-f543750e6e36.mov
